                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-xl-2 col-auto order-0">
                        <div class="header-logo">
                            <NuxtLink to="/">
                                <img class="dark-logo" :src="'/images/logo/logo2.png'" alt="Bokong Semok Dark Logo">
                                <img class="light-logo" :src="'/images/logo/logo2.png'" alt="Bokong Semok Light Logo">
                            </NuxtLink>
                        </div>
                    </div>
                    <!-- Header Logo End -->
                    ...
                    <div class="col-xl-2 col d-none d-sm-flex justify-content-end order-1 order-xl-2">
                        <a href="https://shop.bokongsemok.co.uk" class="btn btn-light btn-hover-primary" target="_blank">Shop Now</a>
                    </div>
                    <!-- Header Right End -->
